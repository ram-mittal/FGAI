  ...
  modules: [
    {
      ...
      description:
        "Foundations of generative AI — discriminative vs. generative models, Hugging Face ecosystem, and text generation with GPT-2.",
      overview:
        "This module introduces the fundamental concepts of generative AI. You will learn the difference between discriminative and generative models, set up the Hugging Face Transformers library, and generate text using GPT-2. The module establishes the foundation for all subsequent generative AI topics.",
      topics: [
        { id: "t1-1", title: "What is Generative AI?" },
        { id: "t1-2", title: "Discriminative vs. Generative Models" },
        { id: "t1-3", title: "Overview of Generative AI Applications" },
        { id: "t1-4", title: "Introduction to Hugging Face Transformers" },
        { id: "t1-5", title: "Text Generation with GPT-2" },
        { id: "t1-6", title: "Setting Up the GenAI Development Environment" },
      ],
      notes: [
        {
          id: "n1-1",
          title: "Module 01 — Lecture Notes",
          description: "Introduction to Generative AI concepts and tools",
          type: "pdf",
          url: "#",
          downloadUrl: "#",
        },
        {
          ...
          description: "Step-by-step guide to install and configure HF Transformers",
          type: "markdown",
          url: "#",
          downloadUrl: "#",
        },
    ...
    },
    {
      ...
      description:
        "Fundamentals of prompting — basic prompts, instruction-based prompting, and DistilGPT-2.",
      overview:
        "Prompt engineering is the art of crafting effective inputs for language models. This module covers basic prompting techniques, instruction-based prompting, and how to work with DistilGPT-2. You will learn how prompt design directly impacts the quality and relevance of generated outputs.",
      topics: [
        { id: "t2-1", title: "What is Prompt Engineering?" },
        { id: "t2-2", title: "Basic Prompting Techniques" },
        { id: "t2-3", title: "Instruction-Based Prompting" },
        { id: "t2-4", title: "Working with DistilGPT-2" },
        { id: "t2-5", title: "Prompt Templates and Formatting" },
        { id: "t2-6", title: "Evaluating Prompt Effectiveness" },
      ],
      notes: [
        {
          id: "n2-1",
          title: "Module 02 — Lecture Notes",
          description: "Basic prompt engineering techniques and strategies",
          type: "pdf",
          url: "#",
          downloadUrl: "#",
        },
...
print("Gradio app launched!")`,
  ...
  videoResources: [
    ...
    },
    {
      ...
      platform: "YouTube — Arxiv Insights",
    },
    {
      id: "vid-4",
      title: "GANs from Scratch in PyTorch",
      topic: "GANs Implementation",
      duration: "45 min",
      url: "https://www.youtube.com/watch?v=OljTVUVzPBk",
      platform: "YouTube — Aladdin Persson",
    },
    {
      id: "vid-5",
